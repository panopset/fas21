...
open class BlackjackGameEngine(private val logDisplayer: LogDisplayer, val config: com.panopset.fsb.engine.BlackjackConfiguration) {
     ...
     */
    fun getShoe(): com.panopset.fsb.engine.BlackjackShoe {
     ...
     * @param player Player.
     */
    private fun reasonThisGameExists(player: com.panopset.fsb.engine.Player?) {
