...
import com.panopset.fsb.engine.BlackjackMessages
import com.panopset.fsb.engine.CountingSystems
import com.panopset.compat.Logz
import com.panopset.fsb.fsbdesk.games.bj.*
    ...
    fun create(fxDoc: FxDoc): BlackjackConfiguration {
        ...
        val rtn = object: BlackjackConfiguration {
            ...
            override fun getCountingSystems(): CountingSystems {
                var countingSystems = CountingSystems(
                    fxDoc.getArrayListValue(KEY_COUNTING_SYSTEMS_DATA)
                )
                ...
                if (countingSystems.countingSystemsData.isEmpty()) {
                    countingSystems =
                        CountingSystems(dft.countingSystemsData)
                }
