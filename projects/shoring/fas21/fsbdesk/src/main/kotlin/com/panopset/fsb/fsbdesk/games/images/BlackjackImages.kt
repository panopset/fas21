package com.panopset.fsb.fsbdesk.games.images
...
object BlackjackImages {
     ...
     */
    private const val DFT_CARD_IMAGE = "/com/panopset/fsb/marin/game/card/images/jfitzcards.png"


    /**
     * Panopset owned image, (which means it is open source) created by Karl Dinwiddie 2012-05-19.
     */
    private const val DFT_CHIP_IMAGE = "/com/panopset/fsb/marin/game/card/images/chips.png"

    /**
     * Panopset owned image.
     */
    private const val ARROW_IMAGE = "/com/panopset/fsb/marin/game/card/images/arrow.png"
